...
const Progressbar = ({classes,title,subtitle1,subtitle2,subtitle3,subtitle4,subtitle5,shipment1,shipment2,shipment3,shipment4,shipment5,value1,value2,value3,value4,value5,button=false})=> {
    return(
        <div className={`bg-white shadow-xl py-1 px-4 my-2 font-sans ${classes}`} >
            <div className='flex justify-between p-2 mb-1'>
                <h6 className="font-semibold font-sans text-gray-600">{title} </h6>
             ...
             <div>
                <div className="relative pt-1" style={{fontSize:'0.7em'}}>
                        <div className="clearfix  text-gray-500  font-bold flex justify-between ">
                            <span className="pull-right m-0 fw-semi-bold">{subtitle1} <span className='my-3'>{(button) && <ButtonSearch/>}</span></span>
            ...
            <div>
                ...
                <div className="relative pt-1" style={{fontSize:'0.7em'}}>
                <div className="clearfix text-gray-500 font-bold  flex justify-between">
                            <span className="pull-right m-0 fw-semi-bold">{subtitle3} <span className='my-3'>{(button) && <ButtonSearch/>}</span></span>
            ...
            <div>
                ...
                <div className="relative pt-1" style={{fontSize:'0.7em'}}>
                <div className="clearfix  text-gray-500 font-bold  flex justify-between">
                            <span className=" m-0  ">{subtitle4} <span className='my-3'>{(button) && <ButtonSearch/>}</span></span>
            ...
            <div>
                ...
                <div className="relative pt-1" style={{fontSize:'0.7em'}}>
                <div className="clearfix  text-gray-500  flex font-bold  justify-between">
                            <span className="pull-right m-0 fw-semi-bold">{subtitle5} <span className='my-3'>{(button) && <ButtonSearch/>}</span></span>
